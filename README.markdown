...
In your Rakefile, or some other file in `lib/tasks` (ex: `lib/tasks/resque.rake`), load
the resque rake tasks.  Also, by default Resque won't know about your application's
